...
export type ParsedCollectionItemOptionQuery<T extends ServerCollectionItemOptionModel> =
    | {
          post: PostItem
...
export const parseServerCollectionItemOptionQuery = <T extends ServerCollectionItemOptionModel>(
    value: unknown,
    option: T,
): ParsedCollectionItemOptionQuery<T> => {
